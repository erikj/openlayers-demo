...
(function() {
  var CATMAP, makePlaneMarker, newPlaneLayer, onFeatureSelect, onFeatureUnselect;
  ...
  CATMAP.load_map = function(map_div_name) {
    ...
    for (m = 0, len3 = multipliers.length; m < len3; m++) {
      ...
      for (n = 0, len4 = goesCoImages.length; n < len4; n++) {
        image = goesCoImages[n];
